...
function parseOutput(text) {
  ...
  for (const line of lines) {
    ...
    if (inSelectionsSection || !reasoning) {
...
export function validateSelections(output, musicSamples, textureSamples = null) {
  ...
  // Validate texture_filename exists
  ...
  // CRITICAL: Scale constraint validation
  if (musicSample) {
  ...
  return {
    ...
    reasoning,
    musicSample,
    textureSample: textureSamples?.find(s => s.filename === selections.texture_filename),
    errors
  };
}
