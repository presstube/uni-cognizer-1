...
-- Migration 017: Add sound_prompts and sound_csv_files tables
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_sound_prompts_active 
  ON sound_prompts (active) 
  WHERE active = true;

-- Track updates
CREATE INDEX IF NOT EXISTS idx_sound_prompts_updated 
  ON sound_prompts (updated_at DESC);

-- CSV files table for music/texture samples
...
CREATE INDEX IF NOT EXISTS idx_sound_csv_files_default 
