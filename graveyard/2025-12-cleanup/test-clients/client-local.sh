...
# Client Local - Starts real server + opens test client connecting to localhost
...
echo -e "${YELLOW}🚀 Starting UNI Test Client (Local - Real Server)${NC}"
echo ""
...
# Start backend server in background (with logs visible)
...
# Start the http-server in background (silent, no logs needed)
...
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${GREEN}  UNI Test Client Running (Local - Real Server)${NC}"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo -e "  ${YELLOW}Client URL:${NC}  $CLIENT_URL"
echo -e "  ${YELLOW}Backend:${NC}     http://localhost:$BACKEND_PORT (Real LLM)"
echo -e "  ${YELLOW}Backend PID:${NC} $BACKEND_PID"
echo -e "  ${YELLOW}Client PID:${NC}  $CLIENT_PID"
echo ""
echo -e "${RED}⚠️  Using real LLM API calls (costs money)${NC}"
echo ""
